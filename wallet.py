...
class Wallet:
    ...
    def save_keys(self):
        ...
        if self.public_key is not None and self.private_key is not None:
            try:
                with open('wallet-{}.txt'.format(str(self.node_id)[:8]), mode='w') as f:
    ...
    def generate_keys(self):
        ...
        """Generate a new pair of private and public key."""
            ...
            print("Public_Key Assignment falied..")
    ...
    def sign_transaction(pub_key, vote):
        ...
        h = SHA256.new((str(pub_key) + vote).encode('utf8'))
    ...
    def verify_transaction(transaction):
        ...
        """
        public_key = RSA.importKey(binascii.unhexlify(transaction.public_key))
        verifier = PKCS1_v1_5.new(public_key)
        h = SHA256.new((str(transaction.public_key) +transaction.vote).encode('utf8'))
